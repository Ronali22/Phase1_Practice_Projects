package com.practice.assigment28;
...
public class DoublyLinkedListEx {
	...
	public static void main(String[] args) {
		...
		DoublyLinkedListEx obj = new DoublyLinkedListEx();

		obj.addNewNode("Shyam");
		obj.addNewNode("Kumari");
		obj.addNewNode("harshita");
		obj.addNewNode("raju");
		obj.addNewNode("simran");
		obj.showData();
	}
